...
class MainGrid(BoxLayout):
    ...
    def show_info():
        ...
        info.ids.infoText_p5.text = "\n\n\n[b]Quick overview behind the maths[/b]" \
                                    ...
                                    "[size=20sp]"+LatexNodes2Text().latex_to_text(r'$a[sub]c[/sub] \sin(2\pi f[sub]c[/sub] x[sub]c[/sub] + [b]\beta a[sub]m[/sub] \int\ sin(2\pi f[sub]m[/sub] x[sub]m[/sub])dx[/b])$')+"[/size]"\
                                    "\n\n"+LatexNodes2Text().latex_to_text(r'$[i]\beta$')+": modulation index" \
                                    " ("+LatexNodes2Text().latex_to_text(r'$f[sub]\Delta[/sub]/f[sub]m[/sub]$')+") \n" \
